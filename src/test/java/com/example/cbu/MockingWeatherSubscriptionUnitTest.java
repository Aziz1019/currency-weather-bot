...
public class MockingWeatherSubscriptionUnitTest {
    @InjectMocks
    ...
    @Test
    public void checkWeatherSubscription() {
        // given
        Message message = new Message();
        SendMessage sendMessage = new SendMessage();
        UserSubscription userSubscription = new UserSubscription();
        userSubscription.setUserId(1L);
        userSubscription.setWeatherSubscription(false);
        message.setText("15:00");
        ...
        // when
        switchStatesCommand.executeWeatherSubscription(sendMessage, message, Optional.of(userSubscription), environment);
        String actual = sendMessage.getText();
        String expected = "Sizning tanlangan vaqtingiz: 15:00";
        Assert.assertEquals(expected, actual);
        Assert.assertTrue(userSubscription.getWeatherSubscription());
